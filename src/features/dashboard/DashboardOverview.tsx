...
import useDashboardOverviewQuery from "./api/queries/useDashboardOverviewQuery";
...
const PageTitle = styled.h1<{ $isMobile: boolean }>`
  ...
  display: flex;
  ${({ $isMobile }) =>
    $isMobile ? designSystem.font.heading4 : designSystem.font.heading2};
`;
...
const MainTitle = styled.div<{ $isMobile: boolean }>`
  margin-right: auto;
  ${({ $isMobile }) =>
    $isMobile ? designSystem.font.title5 : designSystem.font.title4};
  color: ${designSystem.color.neutral.gray400};
`;

const MainWon = styled.div<{ $isMobile: boolean }>`
  ${({ $isMobile }) =>
    $isMobile ? designSystem.font.title2 : designSystem.font.display3};
...
const MainValue = styled.div<{ $isMobile: boolean }>`
  ${({ $isMobile }) =>
    $isMobile ? designSystem.font.display3 : designSystem.font.heading1};
`;
...
const Won = styled.div<{ $isMobile: boolean }>`
  ${({ $isMobile }) =>
    $isMobile ? designSystem.font.title3 : designSystem.font.title2};
  color: ${designSystem.color.neutral.gray600};
`;

const Value = styled.div<{ $isMobile: boolean }>`
  ${({ $isMobile }) =>
    $isMobile ? designSystem.font.title2 : designSystem.font.title1};
`;
